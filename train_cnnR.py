...
model.save("D:/PycharmProjects/AtariDQN/models/freeway_cnn_0.075_500000_g0.84.zip")
...
env = make_vec_env(lambda: env, n_envs=1)
model = DQN.load("D:/PycharmProjects/AtariDQN/models/freeway_cnn_0.075_300000_g0.80.zip", env=env)
obs = env.reset()
total_reward = []
acc_reward = 0
for _ in range(500):
