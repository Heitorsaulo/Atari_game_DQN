...
modelo_path = "mlp-recompensa-padrao/freeway_dqn_mlp_model.zip"

if os.path.exists(modelo_path):
    print("Carregando modelo existente...")
    modelo = DQN.load("mlp-recompensa-padrao/freeway_dqn_mlp_model.zip", env=env)
else:
    ...
    modelo.save("mlp-recompensa-padrao/freeway_dqn_mlp_model.zip")
