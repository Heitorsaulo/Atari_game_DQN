...
model.save("mlp-recompensa-personalizada/freeway_dqn_mlp_personalizada_model.zip");
...
if __name__ == "__main__":
    # Testar o wrapper
    test_model("mlp-recompensa-personalizada/freeway_dqn_mlp_personalizada_model.zip")